...
char AttemptRow(char row_number, char board[9]) {
    /*
        ...
        �� ����� �������� ��� 3�� ������� ��� board ����� ���� ���� 6
        ����� ������ ��� � ����� ������ ��� ����� ��� ������ ��������� ��� n-����� ������� ��� board �� ��� ������ n
        ����� � 3*(n-1)=3*n-3, �������� ��� n=1 => ����� �������� ���� ���� 3*n-3=3*1-3=0
                                        ��� n=2 => ����� �������� ���� ���� 3*n-3=3*2-3=6-3=3
                                        ��� n=3 => ����� �������� ���� ���� 3*n-3=3*3-3=9-3=6
    */
    int sum_x=0,
        sum_o=0;
    int beg;
...
char blockColumn(char column_number, char board[9]) {
    ...
    beg=column_number-1; // ����� ������ ��� AttemptColumn.
    for(i=0; i<3; i++)
        if(board[beg+i*3]==0)
            return beg+i*3;
